        ...
        funnelSteps: [
            {
                step: "Traffic (流量渠道)",
                desc: "花钱或用内容向平台买精准曝光。",
                popupText: "去哪里找客源？不管是谷歌搜词还是小红书发帖，没挑对平台，广告费打水漂；挑对了，就算花点钱也能引来真想买保险的人。",
                popupImage: '/images/funnel_popup_traffic.png'
            },
            {
                step: "Assets (创意资产)",
                desc: "用极高质感的视觉与文案，让客户停下手指。",
                popupText: "怎么让客户不划走？满大街都在发传单，你的海报要是也丑，谁看啊。你得用高颜值的视频、直击痛点的文字，第一秒就抓住他们。",
                popupImage: '/images/funnel_popup_assets.png'
            },
            {
                step: "Functional Web (收网阵地)",
                desc: "用交互式网站把访客过滤、洗成带有电话的优质 Leads。",
                popupText: "好不容易找到了感兴趣的客户，需要有方法跟客户产生互动，有客户的联系方式，知道是谁主动联系了你，才能跟进后续的步骤。毕竟我们卖的产品不是冲动消费",
                popupImage: '/images/funnel_popup_web.png'
            },
            {
                step: "AI & Follow-up (最强大脑)",
                desc: "用AI秒查核保规则，生成方案，建立专业信任。",
                popupText: "拿到电话后怎么谈？别等客户发问你现翻书。用AI一秒查出最新规定、一键做份最专业的企划书发过去，瞬间建立绝对信任。",
                popupImage: '/images/funnel_popup_ai.png'
            }
        ]
    },
        ...
        quadrants: [
            {
                ...
                color: "blue",
                popupTitle: "Google Ads (谷歌大生态)",
                popupText: "谷歌广告非常多样，不只有你以为的搜词竞价排名，还有视频、图片展示等极其丰富的形式。核心特点是：客户主动搜索，意图最明确，只要展现的内容精准，成交率最高。"
            },
            {
                title: "被动刷手机消遣",
                ...
                color: "fuchsia",
                popupTitle: "TikTok & Meta (FB/IG)",
                popupText: "大家刷手机只是为了娱乐，你必须要有非常吸睛、能挑动情绪的内容才能留住他们。流量极大也最便宜，适合靠量取胜。"
            },
            {
                title: "长视频专家滤镜",
                platform: "YouTube",
                ...
                color: "red",
                popupTitle: "YouTube (油管视频)",
                popupText: "这是专门打造专家个人IP的地方。愿意看几分钟长视频的客户，其实都在寻找专业知识。看完你的干货，他们就会自动把你当成权威。"
            },
            {
                title: "华人特供圈层",
                platform: "小红书 / 微信",
                ...
                color: "emerald",
                popupTitle: "小红书 & 微信",
                popupText: "做多伦多华人生意绕不开的两大阵地。小红书靠精美的封面吸引关注，微信靠朋友之间的推荐建立信任。这俩平台主打一个熟人圈子和口碑分享。"
            }
        ]
    },
    platforms: {
        google: {
            title: "精准主动搜索：Google Ads 生态",
            points: [
                "不仅仅是竞价排名（Search）：还包括 YouTube 视频、千万家网站联盟（Display）等极多样的广告形式。",
                "底层机制：客户遇到了确切的问题，主动去搜索答案（就好比已经准备好钱去买东西），所以他们的购买意愿和转化率是全网最强的。",
                "价格差距大：搜索词越含糊（范围越广），点击费越贵，而且想要排名靠前往往都不便宜。",
                "核心打法：打“长尾痛点词”。例如“万锦 父母 超级签证保险 哪家理赔快”（$3/次），而且广告与落地页必须严格配合、完全对应，这样才会有效果。"
            ],
            mockSearch: {
        ...
        youtube: {
            ...
            points: [
                "底层机制：贴片插播（In-stream）。视频播放前强制观看的广告，建立专家形象。",
                "预估价格：只有当观众看满30秒（或者看完整个较短的视频），或者点击了广告，你才需要付钱。单次有效观看大约 $0.05 - $0.20。",
                "核心打法：用“干货拆解”视频定点投放。例如：你录制了一段3-8分钟的视频，详细在白板上拆解“企业主如何用保单合法避税？”，然后你在后台设置，把这个视频专门投给居住在列治文山或Oakville这些高收入邮编区的人看。在这个过程中你建立了绝对的专业权威地位。"
            ],
            mockVideo: {
        ...
        meta: {
            title: "基于人生大事的精准推送：Meta (FB/IG)",
            points: [
                "底层机制：基于用户的日常行为和兴趣标签进行强行推送。算法知道用户最近在关注什么、经历了什么。",
                "预估价格：获取一个填了表单的潜在客户线索（Lead）大约需要 $30 - $80 加币。这个成本是由“广告展示的千人成本(CPM)”乘以“点击率”再乘以“表单转化率”算出来的。因为你要在别人娱乐时硬塞广告，所以转化率不会像主动搜索那么高，导致最终拿到一个电话的成本在这个区间之内。",
                "核心打法：利用“人生重大事件 (Life Events)”进行定向推送。例如：系统能精准识别出过去3个月内“刚买了新房”或“刚生了宝宝”的人群，你可以直接把“房屋贷款保险”或“教育基金/儿童重疾险”的广告推送到他们的手机屏幕上，转化率极高。"
            ],
            assetsTrends: [
        ...
        tiktok: {
            title: "流量暴风眼：TikTok",
            points: [
                "底层机制：纯粹的兴趣推荐。大家都是来找乐子的，如果你的视频前3秒不够吸引人、不够有冲突感，他们就会瞬间划走。",
                "预估价格：流量极大且获取线索的成本较低，大概 $10 - $15 加币/Lead。但由于属于冲动型填写，线索质量参差不齐，非常考验后续销售“洗流量”的能力。",
                "核心打法：UGC（用户生成内容）原生感 + 强情绪输出。不能像是正儿八经的广告。例如用手机拿着边走边拍：“安省车主注意，这3个附加险纯属冤大头！”"
            ],
            mockVideo: {
                author: "@多伦多保险大实话",
        ...
        xiaohongshu: {
            ...
            points: [
                ...
                "内容组织核心：制造焦虑。用极其吸睛和夸张的标题（例如“千万别买错”、“纯属冤大头”）点出客户可能面临的严重后果，迫使客户因为害怕犯错而立刻向你咨询。"
            ],
            mockPosts: [
                {
                    coverTag: "避坑指南",
        ...
        wechat: {
            title: "私域信任终极堡垒：微信生态",
            points: [
                "底层机制：熟人裂变。你发个视频或者深度文章，一个高管朋友点赞，他几百个企业主朋友全能刷到，天然带着信任背书。",
                "深度背书：公众号发万字深度税务长文或“白皮书”，直接发给大客户做专业信任背书。",
                "人设打造：视频号发日常理赔跑腿的Vlog，朋友圈发高级的日常工作照立“靠谱与繁忙”人设。"
            ]
        }
    },
